// src/data/readingPlan/weeks.ts
import type { ReadingWeek } from "./types";

// All 52 weeks in one beautiful array — no imports, no errors, fully modular
...
import { week46 } from "./week46";
import { week47 } from "./week47";
import { week48 } from "./week48";
import { week49 } from "./week49";
import { week50 } from "./week50";
import { week51 } from "./week51";
import { week52 } from "./week52";

export const allWeeks: ReadingWeek[] = [
